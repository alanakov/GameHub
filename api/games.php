<?php
    ...
    "poster"=>"{$path}poster_fallout.jpg","banner"=>"imagens/meowtopiaBanner.jpg","trailer"=>"https://www.youtube.com/embed/M9FGaan35s0");
    ...
    "poster"=>"{$path}poster_sf6.jpg","banner"=>"imagens/CYBERGUNBanner.jpg","trailer"=>"https://www.youtube.com/embed/3sAU1fPK0K4");
    ...
    "poster"=>"{$path}poster_mk1.jpg","banner"=>"imagens/omegaCollapseBanner.jpg","trailer"=>"https://www.youtube.com/embed/Ue1Yo-3QnRc");
    ...
    "poster"=>"{$path}poster_fc24.jpg","banner"=>"imagens/crimsonCurseBanner.jpg","trailer"=>"https://www.youtube.com/embed/XhP3Xh4LMA8");
