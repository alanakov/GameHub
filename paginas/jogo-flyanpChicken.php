...
<div class="d-xl-flex flex-xl-row">
    ...
    <div class="d-flex mt-5">
        <div class="m-5">
            ...
            <p class="text-white">Cluckina é uma galinha corajosa e determinada que escapou do confinamento da fazenda em busca de liberdade. Com penas brancas e olhos vivos, ela enfrenta o desafio de voar pelo campo aberto enquanto é perseguida por gaviões famintos.</p>


            <div class="mt-xl-5 d-none d-md-block">
                <a href="jogos/flyingchicken/index.html" target=”_blank” class="btn bg-danger text-white fs-6 fw-semibold px-5 p-2 p-xl-3 d-flex justify-content-center mx-xl-5" style="margin-top: 11.5em">JOGAR AGORA</a>
            </div>
