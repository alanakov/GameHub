...
<div data-aos="fade-up" class="d-xl-flex flex-xl-row">
    <div class="d-flex flex-column m-5 gap-3">
        <div class="d-flex">
            <h2 class="text-white"><strong>A Arte da Ocultação</strong></h2>
    ...
    <div class="d-flex mt-5">
        <div class="m-5">
            ...
            <p class="text-white">Você é um habilidoso shinobi em um jogo 2D, lutando contra hordas de esqueletos. Acumule pontos derrotando inimigos cada vez mais desafiadores. Alcance a pontuação final para vencer e trazer paz ao mundo assombrado.</p>


            <div class="mt-xl-5 d-none d-md-block">
                <a href="jogos/arte/index.html" target=”_blank” class="btn bg-danger text-white fs-6 fw-semibold px-5 p-2 p-xl-3 d-flex justify-content-center mx-xl-5" style="margin-top: 11.5em">JOGAR AGORA</a>
            </div>
