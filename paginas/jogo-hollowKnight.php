<img class="w-100" src="imagens/meowtopiaBanner.jpg" alt="Hollow Knight">

<div class="d-xl-flex flex-xl-row">
    <div class="d-flex flex-column m-5 gap-3">
        <div class="d-flex">
            <h2 class="text-white"><strong>Hollow Knight</strong></h2>
        ...
        <div id="carouselExampleIndicators" class="carousel slide container">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="imagens/foto-meowtopia-grande-1.jpeg" class="d-block" alt="Imagem do jogo Hollow Knight">
                </div>
                <div class="carousel-item">
                    <img src="imagens/foto-meowtopia-grande-2.jpeg" class="d-block" alt="Imagem do jogo Hollow Knight">
                </div>
                <div class="carousel-item">
                    <img src="imagens/foto-meowtopia-grande-3.jpeg" class="d-block" alt="Imagem do jogo Hollow Knight">
                </div>
            </div>
