    ...
    <div class="d-flex mt-5">
        <div class="m-5">
            ...
            <div class="mt-xl-5 d-none d-md-block">
                <a href="crimsonCurse/index.html" target=”_blank” class="btn bg-danger text-white fs-6 fw-semibold px-5 p-2 p-xl-3 d-flex justify-content-center mx-xl-5" style="margin-top: 11.5em">JOGAR AGORA</a>
            </div>
